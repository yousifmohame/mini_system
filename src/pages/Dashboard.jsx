...
// 💡 1. استيراد المودال الاحترافي المنفصل
...
const Dashboard = () => {
  ...
  // ==================================================
  // Forms States (تم حذف TransactionForm لأنه أصبح في المودال المنفصل)
  // ==================================================
  ...
  const { data: clients = EMPTY_ARRAY, isLoading: isLoadingClients } = useQuery(
    {
      ...
      enabled: isCollectionModalOpen, // يُستخدم الآن في التحصيل فقط
    },
  );
  ...
  return (
    <>
      {/* ================================================== */}
      {/* 💡 2. استدعاء مودال إنشاء معاملة جديدة المنفصل */}
      {/* ================================================== */}
      <CreateTransactionModal
        isOpen={isNewTransactionModalOpen}
        onClose={() => setIsNewTransactionModalOpen(false)}
        refetchTable={() => {
          // لتحديث إحصائيات الداشبورد بعد الإنشاء
          queryClient.invalidateQueries(["private-dashboard-stats"]);
          queryClient.invalidateQueries(["private-transactions-simple"]);
        }}
      />
